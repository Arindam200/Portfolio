...
export default function EmailForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex-col flex space-y-2">
      ...
      <button
        type="submit"
        className="px-64 py-2 border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 rounded p-1 text-sm inline-flex items-center leading-4 text-neutral-900 dark:text-neutral-100 mb-4"
      >
        Submit
      </button>
    </form>
